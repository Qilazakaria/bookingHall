		...
		<div class="wrapper">
				...
				<h2 style="text-align:center;"> Make Booking </h2> 
				     <div class="input-username">
						<input type="date" placeholder="Enter Date" name="bookingDate"  autocomplete="off"><br><br>
				    </div>
				    
				    <div class="input-time">
						<input type="time" placeholder="Enter Time" name="bookingTime" autocomplete="off"><br><br>
				    </div>
				    
					<div class="input-description">
						
						<input type="text" placeholder="Enter Description" name="bookingDescription" autocomplete="off"><br><br>
					</div>
					
					<div class="input-capacity">
						
						<input type="text" placeholder="Enter Capacity" name="bookingEstimateCapacity" autocomplete="off"><br><br>
					</div>
					
					<div class="input-price">
						
						<input type="text" placeholder="Enter Price" name="bookingPrice" autocomplete="off"><br><br>
					</div>
            </div>
